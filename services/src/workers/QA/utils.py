...
from src.dependencies import json,sys,time,uuid,QA_SUMMARISER_OPENAI_ASSISTANT_ID,ADMIN_ID_QA,COURSE_ID_QA,TOPIC_ID_QA
...
def get_QA(conversation):
    ...
    try : 
        ...
        if(messages):
            QA[dummy_uuid] = messages.data[0].content[0].text.value
        else:
            QA[dummy_uuid] = {"question" : "Not available", "answer" : "Not available"}
...
def create_vector(QA,ADMIN_ID,COURSE_ID,TOPIC_ID):
    """
...
def delete_vectors(qa_id,ADMIN_ID,COURSE_ID,TOPIC_ID):
    """
