...
from API.schemas.polling.documents import SQSMessageAttributes
...
def process_post_message_knowledge_base(message_info: dict):
    """
        Function to process the POST message for Documents Knowledge Base
        
        Args:
            message_info : The message attributes received from SQS
            
        Returns:
            final_upload_status : The final upload status of the records
    """
    try:
...
def process_delete_message_knowledge_base(message_info: dict):
    """
        Function to process the DELETE message for Documents Knowledge Base
        
        Args:
            message_info : The message attributes received from SQS
            
        Returns:
            final_response : The final response of the deletion of records
    """
    try :
        key = message_info["key"]["StringValue"]
...
def process_incoming_SQS_knowledge_base(message: SQSMessageAttributes):
    """
        Function to process the incoming SQS message for Documents Knowledge Base
...
def process_post_message_QA_base(message_info: dict):
    """
        Function to process the POST message for QA Base
...
def process_delete_message_QA_base(message_info: dict):
    """
        Function to process the DELETE message for QA Base
...
def process_incoming_SQS_QA_base(message : SQSMessageAttributes):
    """
        Function to process the incoming SQS message for QA Base
